var h = {}, mt = {}, c = {id: "0c0e9d9b1e7d617b3e6842e85b9fb068",
        dm: ["jianshu.com"],
    ...
    (function() {
        ...
        mt.e.getAttribute = function(a, b) {
            ...
            if (!d && a.attributes && a.attributes.length)
                for (var g = a.attributes, l = g.length, m = 0; m < l; m++)
                    g[m].nodeName === b && (d = g[m].nodeValue);
            return d
        }
        ;
        mt.e.K = function(a) {
        ...
        mt.e.Qa = function(a) {
            var b = mt.e.K(a);
            "input" === b && ("button" === a.type || "submit" === a.type) ? a = a.value || "" : "img" === b ? (b = mt.e.getAttribute,
            a = b(a, "alt") || b(a, "title") || b(a, "src")) : a = "body" === b || "html" === b ? ["(hm-default-content-for-", b, ")"].join("") : mt.e.Wa(a);
        ...
        (function() {
            (mt.e.ib = function() {
                ...
                : document.attachEvent && (l = function() {
                    "complete" === document.readyState && (document.detachEvent("onreadystatechange", l),
                    a())
                }
                );
                (function() {
                    if (!d)
                        ...
                        "complete" === document.readyState)
                            ...
                            document.addEventListener("DOMContentLoaded", l, u),
    ...
    mt.localStorage.set = function(b, a, e) {
        ...
        try {
            ...
            window.localStorage.setItem(b, a)) : mt.localStorage.Q() && (mt.localStorage.h.expires = d.toUTCString(),
            mt.localStorage.h.load(document.location.hostname),
            mt.localStorage.h.setAttribute(b, a),
    ...
    (function() {
        var b = {
            ...
            I: function(a, b) {
                this.p[a] = this.p[a] || [];
                for (var d = this.p[a].length, g = 0; g < d; g++)
                    this.p[a][g](b)
            }
        };
        return h.A = b
    ...
    (function() {
        var b = mt.lang
          ...
          , f = {
            ...
            S: function(a) {
                a.length > g.U || (encodeURIComponent(n.join("!") + a).length > g.U && (f.H(n.join("!")),
                n = []),
                n.push(a))
            },
            H: function(a) {
    ...
    (function() {
        var b = mt.event
          ...
          , n = {
            Ja: function() {
                return function() {
                    h.b && (h.b.D && c.aet && c.aet.length) && (window.clearTimeout(m),
            ...
            S: function(a) {
                if (encodeURIComponent(l.join("!") + a).length > e.U || 3 < l.length)
                    n.H(l.join("!")),
                    l = [];
                l.push(a)
            },
    ...
    (function() {
        ...
        function d(b) {
            if (!("focus" == b.type || "blur" == b.type) || !(b.target && b.target != window))
                p = "focus" == b.type || "focusin" == b.type ? s : u,
                a()
        }
        var g = mt.event, l = h.A, m = s, n = s, f = s, p = s, k = +new Date, w = k, q = 0, x = s, v = e("visibilityState"), y = e("hidden"), z;
        a();
        (function() {
    ...
    (function() {
        ...
        var e = mt.lang
          ...
          , f = {
            ...
            Ma: function() {
                if (0 < f.F.length)
                    for (var a = 0, b = f.F.length; a < b; a++)
                        f.fa(f.F[a]);
                f.F = t
            },
            fa: function(a) {
                var b = a[0];
                if (f.hasOwnProperty(b) && e.d(f[b], "Function"))
                    f[b](a)
            },
            ...
            _trackEvent: function(a) {
                ...
                h.b.a.st = 4,
                h.b.a.et = 4,
                h.b.a.ep = e.j(a[1]) + "*" + e.j(a[2]) + (a[3] ? "*" + e.j(a[3]) : "") + (a[4] ? "*" + e.j(a[4]) : ""),
                h.b.i())
            },
            _setCustomVar: function(a) {
                if (!(4 > a.length)) {
                    ...
                    if (0 < b && 6 > b && 0 < d && 4 > d) {
                        f.P++;
                        for (var q = (h.b.a.cv || "*").split("!"), x = q.length; x < b - 1; x++)
                            q.push("*");
                        q[b - 1] = d + "*" + e.j(a[2]) + "*" + e.j(a[3]);
                        h.b.a.cv = q.join("!");
                        a = h.b.a.cv.replace(/[^1](\*[^!]*){2}/g, "*").replace(/((^|!)\*)+$/g, "");
                        "" !== a ? h.b.setData("Hm_cv_" + c.id, encodeURIComponent(a), c.age) : h.b.jb("Hm_cv_" + c.id)
                    }
                }
            },
            ...
            _setReferrerOverride: function(a) {
                1 < a.length && (h.b.a.su = a[1].charAt && "/" === a[1].charAt(0) ? l.protocol + "//" + window.location.host + a[1] : a[1],
                f.ua = s)
            },
            ...
            _trackRTPageview: function(b) {
                ...
                e.d(b, "Object") && (a(b),
                b = d.stringify(b),
                512 >= encodeURIComponent(b).length && (f.f |= 64,
                h.b.a.rt = b))
            },
            _trackRTEvent: function(b) {
                ...
                if (e.d(b, "Object")) {
                    ...
                    if (900 >= m)
                        ...
                        for (var m = Math.ceil(m / 900), q = "block|" + Math.round(Math.random() * l.da).toString(16) + "|" + m + "|", x = [], v = 0; v < m; v++)
                            x.push(v),
    ...
    (function() {
        function b() {
            ...
            this.ra = this.qa = s,
            this.D = k.D,
            this.na = g.aa() && 0 < c.aet.length ? c.aet.split(",") : "",
            this.$ = u,
            this.init())
        }
        var a = mt.url
        ...
        b.prototype = {
            ...
            W: function() {
                for (var a = 0, b = c.dm.length; a < b; a++) {
                    var d = c.dm[a];
                    if (-1 < d.indexOf("/") && this.va(document.location.href, d))
                        return d.replace(/^[^/]+(\/.*)/, "$1") + "/"
                }
                return "/"
            },
            Va: function() {
                if (!document.referrer)
                    return k.s - k.w > c.vdur ? 1 : 4;
                var b = u;
                this.N(document.referrer) && this.N(document.location.href) ? b = s : (b = a.Y(document.referrer),
                b = this.ba(b || "", document.location.hostname));
            ...
            pb: function() {
                ...
                if (0 === c.nv && this.N(document.location.href) && ("" === document.referrer || this.N(document.referrer)))
                    a = 0,
                    b = 4;
                this.a.nv = a;
                this.a.st = b;
            ...
            Ga: function() {
                ...
                b && (d.test(b) && e && g) && (this.a.rnd = Math.round(Math.random() * k.da),
                b = document.createElement("script"),
                b.setAttribute("type", "text/javascript"),
                b.setAttribute("charset", "utf-8"),
                b.setAttribute("src", k.protocol + "//" + c.js + f + ".js?" + this.a.rnd),
        ...
        if ("undefined" !== typeof h.b && (c.med || (!b.sa || 7 < b.eb) && c.cvcc)) {
            var g, l, m, n, f = function(a) {
                ...
                if (e) {
                    ...
                    f.snv = k) : a.d(l, "String") && m.test(l) && (f.sn = "wrap",
                    f.snv = l);
                    f.id = n
                }
                h.b.a.et = 86;
            ...
            if (c.med)
                ...
                n = {
                    click: function() {
                        for (var a = [], b = f(document.getElementsByTagName("a")), b = [].concat.apply(b, f(document.getElementsByTagName("area"))), b = [].concat.apply(b, f(document.getElementsByTagName("img"))), d, e, g = 0, k = b.length; g < k; g++)
                            d = b[g],
                ...
                n = {
                    click: function() {
                        for (var a = [], b = f(document.getElementsByTagName("a")), b = [].concat.apply(b, f(document.getElementsByTagName("area"))), b = [].concat.apply(b, f(document.getElementsByTagName("img"))), d, e, g, k = 0, l = b.length; k < l; k++)
                            d = b[k],
                            m !== r ? (e = d.getAttribute("onclick"),
                            g = d.getAttribute("href"),
                            w ? (d = d.getAttribute("id"),
                            (m.test(e) || m.test(g) || w.test(d)) && a.push(b[k])) : (m.test(e) || m.test(g)) && a.push(b[k])) : w !== r && (d = d.getAttribute("id"),
                            w.test(d) && a.push(b[k]));
                        return a
                    }
                }
    ...
    (function() {
        ...
        if ("undefined" !== typeof h.b && a.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
            var g = {
                Aa: function() {
                    for (var a = c.cvcf.length, d, n = 0; n < a; n++)
                        (d = b.Oa(decodeURIComponent(c.cvcf[n]))) && e.c(d, "click", g.Ka())
                },
                Ka: function() {
                    return function() {
                        h.b.a.et = 86;
