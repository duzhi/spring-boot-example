...
@Component
@WebFilter(filterName = "Servlet3Filter", urlPatterns = "/bar/*")
...
//	}
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		System.out.println("AFilterAFilterAFilterAFilterAFilter");
        ...
        response.setContentLength("{ccdcdcd:========}".getBytes().length + data.length);
